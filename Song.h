...
class SongLibrary {
    ...
    int numSongs;
    string currentlySorttedBy = "title";
    ...
    void performAddSongFromString(string attributes, const char delimiter, bool sort, string option);
    void performInsertSong(Song newSong);
